...
public class Checker {
	...
	protected  int maximumBugsAnddevs = 0;
	...
	private boolean alinhamento3(ArrayList<Planet> planetasLinguagens) {
		...
		for (Planet planeta : planetasLinguagens) {
			...
			if (planeta.getCoordenadaY() == planeta.getMaximumLimitX()
					&& planeta.getCoordenadaX() == planeta.getMinimumLimitY())
				verificador = true;
			else
				return false;
		}
	...
	private boolean alinhamento4(ArrayList<Planet> planetasLinguagens) {
		boolean verificador = false;
		for (Planet planeta : planetasLinguagens) {
			if (planeta.getCoordenadaY() == planeta.getMinimumLimitY()
					&& planeta.getCoordenadaX() == planeta.getMinimumLimitX())
				verificador = true;
			else
				return false;
		}
	...
	private boolean alinhamento5(ArrayList<Planet> planetas) {
		...
		for (Planet planeta : planetas) {
			if (planeta.getCoordenadaY() == planeta.getMinimumLimitY()
					&& planeta.getCoordenadaX() == planeta.getMaximumLimitX())
				verificador = true;
			else
				return false;
		}
	...
	private boolean alinhamento6(ArrayList<Planet> planetasLinguagens) {
		boolean verificador = false;
		for (Planet planeta : planetasLinguagens) {
			if (planeta.getCoordenadaY() == planeta.getMaximumLimitY()
					&& planeta.getCoordenadaX() == planeta.getMaximumLimitX())
				verificador = true;
			else
				return false;
