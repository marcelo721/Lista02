...
public class JavalarSystem {
	...
	String[] arquivos = { "AE_10.csv", "AE_50.csv", "AE_100.csv", "AE_500.csv", "AE_1000.csv", "AE_1500.csv",
			"AE_2000.csv" };
	...
	public void teste() {
		...
		new AnaliseDeDados(planetaDAO.selecionarPlaneta());
	}
